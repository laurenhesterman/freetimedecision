...
// Questions
const nodes = [{ "node": 1, "message": "Would you like to spend your day outside", "yes": 2, "no": 3 },
             { "node": 2, "message": "Do you want to spend time with other people", "yes": 4, "no": 5 },
             { "node": 3, "message": "Do you want to spend time with other people", "yes": 6, "no": 7 },
             { "node": 4, "message": "Would you mind spending a little money", "yes": 8, "no": 9 },
             { "node": 5, "message": "Would you mind spending a little money", "yes": 10, "no": 11 },
             { "node": 6, "message": "Would you mind spending a little money", "yes": 12, "no": 13 },
             { "node": 7, "message": "Would you mind spending a little money", "yes": 14, "no": 15 },

// TODO: Replace this data with your own.
// Answers & descriptions
             { "node": 8, "message": "Play a team sport or go on a hike with some friends", "yes": 0, "no": 0, "description": "Try a pickup game of volleyball, or check out some nearby hiking trails." },
             { "node": 9, "message": "See if there are any nearby festivals or pucblic events, and go explore together.", "yes": 0, "no": 0, "description": "Look to see if there is a concert in the park or a nearby farmers market." },
             { "node": 10, "message": "Go for a walk or jog while listening to some of your favorite music", "yes": 0, "no": 0, "description": "Find a great playlist and path, and enjoy the fresh air!" },
             { "node": 11, "message": "Go explore some new stores or coffee shops downtown", "yes": 0, "no": 0, "description": "See if you can find any new places you have never seen before." },
             { "node": 12, "message": "Gather some friends and try out a new restraunt", "yes": 0, "no": 0, "description": "Maybe you can share a dessert you have never tried before!" },
             { "node": 13, "message": "Pull out some old board games and cook a meal with a couple friends.", "yes": 0, "no": 0, "description": "See if any of those old games bring back some good memories." },
             { "node": 14, "message": "Learn an instrument or find some new music.", "yes": 0, "no": 0, "description": "There are plenty of tutorials to get you started online." },
             { "node": 15, "message": "Go out to see a movie in theaters, then checkout a nearby museum", "yes": 0, "no": 0, "description": "Enjoy some time alone!" },
];
...
const welcomeMessage = "Welcome to free day decision maker. Are you ready to play?";
...
const decisionMessage = "I think you should";

// This is the prompt to ask the user if they would like to hear a short description of thier activity or to play again
const playAgainMessage = "Say tell me more or tell me about that to hear a short elaboration, or say try again to play the game again.";

// this is the help message during the setup at the beginning of the game
const helpMessage = "I will ask you some questions that will identify what would be best for you. Want to start now?";
...
const utteranceTryAgain = "try again";

const utteranceTellMeAboutThat = "tellmeaboutthat";
